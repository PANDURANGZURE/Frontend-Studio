                  ...
                  <div className='bg-[#ffffff09] p-2 rounded-2xl'>
                    ...
                    <div className='md:flex mb-1'>
                      <div className='md:w-1/2'>
                        ...
                        <div className='flex px-2 gap-2'>
                          <SiGithub title='Github' className="h-10 w-12" />
                          <IoLogoVercel title='Vercel' className="h-10 w-10" />
                        </div>
                      </div>
                    ...
                    <div className='mb-4'>
                      ...
                      <div className='flex px-2 gap-2 h-12 flex-wrap items-center'>
                        ...
                        <Image title='TailwindCSS' src="https://upload.wikimedia.org/wikipedia/commons/d/d5/Tailwind_CSS_Logo.svg" alt="Tailwind" width={48} height={48} />
                        <Image title='GSAP' src="https://cdn.worldvectorlogo.com/logos/gsap-greensock.svg" width={48} height={48} alt="" />
                        <SiNextdotjs title='NextJS' className='text-4xl' />
                        <Image title='Monaco editor' src="data:image/svg+xml,%3csvg%20id='Layer_1'%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%201024%201024'%3e%3cstyle%3e.st0{fill:%23f6f6f6;fill-opacity:0}.st1{fill:%23fff}.st2{fill:%23167abf}%3c/style%3e%3cpath%20class='st0'%20d='M1024%201024H0V0h1024v1024z'/%3e%3cpath%20class='st1'%20d='M1024%2085.333v853.333H0V85.333h1024z'/%3e%3cpath%20class='st2'%20d='M0%2085.333h298.667v853.333H0V85.333zm1024%200v853.333H384V85.333h640zm-554.667%20160h341.333v-64H469.333v64zm341.334%20533.334H469.333v64h341.333l.001-64zm128-149.334H597.333v64h341.333l.001-64zm0-149.333H597.333v64h341.333l.001-64zm0-149.333H597.333v64h341.333l.001-64z'/%3e%3c/svg%3e" alt="Monaco" width={48} height={48} />
                        <img title='Spline' className=' h-10 ' src="https://spline.design/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fspline_logo.647803e0.png&w=128&q=75" alt="" />
                      </div>
                      <div className='m-4'>
                        <Image title='Webpack' src="https://raw.githubusercontent.com/PANDURANGZURE/project-img/bc78cc1a3a962fb92cda3e74c44d079394581fd2/assets/icon/webpack.svg" alt="Webpack" width={48} height={48} />
                      </div>
                    </div>
                  </div>
                </div>
